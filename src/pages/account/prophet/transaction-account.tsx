...
const MOCK_BANKS: Bank[] = [
  { name: "SCB", logoUrl: "/images/banks/scb.svg" },
  { name: "KBank", logoUrl: "/images/banks/kbank.svg" },
  { name: "TMB", logoUrl: "/images/banks/ttb.svg" },
  { name: "UOB", logoUrl: "/images/banks/uob.svg" },
  { name: "GSB", logoUrl: "/images/banks/gsb.svg" },
  { name: "Krungsri", logoUrl: "/images/banks/krungsri.svg" },
];

const MOCK_ACCOUNTS: TransactionAccount[] = [
  {
    id: "1",
    bank: MOCK_BANKS[0], // SCB
    accountName: "Raksakul Hiranas",
    accountNumber: "123-4-56789-0",
  },
  {
    id: "2",
    bank: MOCK_BANKS[1], // KBank
    accountName: "Raksakul Hiranas",
    ...
    <DefaultLayout>
        <div className="justify-center items-center flex flex-col gap-4">
            <div className="flex flex gap-4">
                ...
                <button className="border border-2 border-black px-4 py-2 rounded-full hover:bg-black hover:text-white hover:border-white" onClick={() => setMode("create")}>+</button>
            </div>
