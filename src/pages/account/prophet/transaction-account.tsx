  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex h-100 w-3/4 flex-col items-center justify-center gap-4 overflow-y-scroll rounded-lg border border-2 border-black bg-black px-8 py-16">
          <div className="mt-32" />
