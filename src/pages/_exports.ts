...
// Booking Pages
export { default as BookingPage } from "./booking/[courseId]";
export { default as BookingSuccessPage } from "./booking/booking-success/[bookingId]";
export { default as BookingPaymentPage } from "./booking/payment/[bookingId]";
