      ...
      <GlassContainer>
        <div className="-mt-12 flex flex-col items-center gap-2 p-8">
          ...
          <div className="flex h-[45vh] w-full flex-col items-center gap-4 overflow-y-auto px-4">
            <div className={`bg-neutral-white/90 backdrop-blur-sm rounded-3xl p-4 md:p-8 w-full max-w-4xl flex flex-col lg:flex-row items-start gap-4 md:gap-8 transition-opacity duration-300 ${showQRCode ? 'opacity-30' : 'opacity-100'}`}>
              {/* Course Image */}
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 lg:gap-6 w-full justify-center px-2 md:px-4 max-w-md md:max-w-2xl flex-shrink-0">
            <GlobalButton variant="primary" className="w-full sm:w-auto text-sm md:text-base lg:text-lg px-4 md:px-6 py-2 md:py-3">
              Purchase
            </GlobalButton>
          </div>
        </div>
        ...
        {showQRCode && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className="bg-gradient-to-b from-accent-pink/20 to-accent-pink/30 rounded-3xl p-8 max-w-md w-full mx-4 shadow-2xl backdrop-blur-sm">
              <div className="bg-gradient-to-r from-accent-pink to-accent-violet text-neutral-white text-center py-4 rounded-2xl mb-6">
                <h2 className="text-xl font-semibold font-chakra">QR CODE FOR PAYMENT</h2>
              </div>

              {/* QR Code */}
              <div className="bg-neutral-white rounded-2xl p-6 mb-6 flex justify-center">
                <div className="w-48 h-48 bg-neutral-white border-2 border-border rounded-lg flex items-center justify-center overflow-hidden">
                  <img
              ...
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-neutral-black font-mono">
                  {formatTime(timeLeft)}
                </div>
                <p className="text-neutral-black font-chakra mt-2">กรุณาสแกน QR Code ภายในเวลาที่กำหนด</p>
              </div>

              {/* Cancel Button */}
              <div className="flex justify-center">
                <GlobalButton variant="secondary" className="mt-0" onClick={handleCancel}>
                  Cancel
                </GlobalButton>
              </div>
            </div>
